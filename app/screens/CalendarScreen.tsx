        ...
        {!isPairCalendarOpen && (
          <>
            <input
              ...
              placeholder="コード"
              className="absolute left-[49%] top-[58.3%] h-[28px] w-[20%] rounded-[6px] border border-[#dfc79d] bg-[#fffaf2] px-2 text-[10px] font-bold text-[#3f2116] outline-none"
            />
            <button
              type="button"
              onClick={submitPairCode}
              className="absolute right-[7%] top-[58.3%] h-[28px] w-[24%] rounded-full bg-[#0f6a47] text-[10px] font-black text-[#fff8e6]"
            >
              登録
            </button>
          </>
