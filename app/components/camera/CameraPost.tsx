        ...
        <div className="relative mx-auto h-[100dvh] w-full max-w-md overflow-hidden">
          ...
          {(["prep", "cooking", "finished"] as const).map((type, index) => (
            <CameraShellShot
              ...
              src={isReferenceDraft ? undefined : photos[type]}
          ...
          <button
            ...
            className={`absolute left-[6.2%] top-[93.4%] h-[4.9%] w-[87.6%] rounded-full text-[12px] font-black ${
              isReferenceDraft
                ? "opacity-0"
                : "bg-[#0f6a47] text-[#fff8e6] disabled:bg-[#0f6a47]/50"
            }`}
          >
